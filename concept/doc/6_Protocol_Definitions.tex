...
\label{protocoldef:corerestapi}
\todo{define all the website/app REST calls to interact with DAPNET}

\subsection{Management and User interactions}
...
\subsubsection{Existing Transmitter Groups}

\subsubsection{Rubrics}

\subsubsection{Rubric Content}

\subsubsection{Nodes}

\subsubsection{Third-Party services and subscribers}
...
No authentication required. Here all stored telemetry within the telemetry section from the specified transmitter is provided. Possible sections are 2. Level JSON groups, see \ref{protocoldef:telemetry}.\\
