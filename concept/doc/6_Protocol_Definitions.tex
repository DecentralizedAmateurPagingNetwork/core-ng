...
First get node like in section \ref{protocoldef:microservicesapi:database:getrubricname} to get the revision. Then send the PUT request with just the changed values. The \verb|_id| and \verb|_rev| must be sent always.
...
\todo{muss unten noch eingebaut werden.}
