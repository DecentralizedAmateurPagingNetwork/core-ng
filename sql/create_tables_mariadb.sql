...
DROP DATABASE dapnet;
CREATE DATABASE dapnet 
	CHARACTER SET utf8
...
CREATE TABLE users(
	...
	name VARCHAR(50) COLLATE UTF8_GENERAL_CI NOT NULL UNIQUE,
...
CREATE TABLE nodes(
	id INT AUTO_INCREMENT PRIMARY KEY NOT NULL,
	name VARCHAR(20) COLLATE UTF8_GENERAL_CI NOT NULL UNIQUE,
...
CREATE TABLE pagers(
	...
	name TEXT(20) COLLATE UTF8_GENERAL_CI NOT NULL,
...
CREATE TABLE rubrics(
	...
	name VARCHAR(20) COLLATE UTF8_GENERAL_CI NOT NULL UNIQUE,
	label TEXT(11) COLLATE UTF8_GENERAL_CI NOT NULL
);
